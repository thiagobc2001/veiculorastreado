...
const config = {
  // App information
  appName: rebrandConfig.newAppName || rebrandConfig.originalAppName,
  packageName: rebrandConfig.newPackageName || rebrandConfig.originalPackageName,
  ...
  firebase: {
    projectId: rebrandConfig.firebaseProjectId,
  ...
  colors: {
    ...
    secondary: rebrandConfig.colors?.secondary || '#2196F3',
